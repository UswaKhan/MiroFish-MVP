  ...
  return (
    <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-10 py-8">
      ...
      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3 mb-6">
        <div>
          <span className="font-mono text-[11px] uppercase tracking-[2px] text-[#00e5ff] mb-3 block">Step 03 — Simulation Running</span>
          <h2 className="font-extrabold text-2xl md:text-3xl tracking-tight mb-2" style={{fontFamily:'Syne,sans-serif'}}>Live Simulation Feed</h2>
        ...
        <div className="flex items-center gap-2 font-mono text-sm">
          {done
            ...
            : <><div className="w-2 h-2 rounded-full bg-[#10b981] animate-pulse2" /><span className="text-[#10b981]">Running — Round {round}/40</span></>
          }
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
        {[
          ...
          <div key={s.label} className="bg-[#0f1117] border border-[#1e2535] rounded-xl p-4 flex items-center gap-4">
            ...
            <div>
              <div className="font-mono font-extrabold text-xl text-[#e8eaf0]">{s.val}</div>
      ...
      {/* Feeds — 1 col mobile, 2 col desktop */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[
          ...
          <div key={label} className="bg-[#0f1117] border border-[#1e2535] rounded-2xl overflow-hidden">
            ...
            <div ref={ref} className="h-64 md:h-80 overflow-y-auto p-3.5 flex flex-col gap-2.5">
      ...
      <div className="mt-6">
        <button
          ...
          className="w-full md:w-auto md:float-right inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-[#00e5ff] text-black font-mono font-bold text-sm rounded-xl transition-all disabled:opacity-40 disabled:cursor-not-allowed hover:brightness-110"
        >
