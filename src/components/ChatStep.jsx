  ...
  return (
    <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-10 py-8">
      ...
      <div className="flex flex-col gap-3 md:hidden">
        ...
        {/* Chat box — full height on mobile */}
      ...
      {/* ── DESKTOP LAYOUT ── */}
      <div className="hidden md:grid gap-5" style={{ gridTemplateColumns:'240px 1fr', height:'calc(100vh - 280px)', minHeight:500 }}>
